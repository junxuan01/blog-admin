...
export const LyloDateRangeValueType = '_LyloDateRange' as const;

type RangePickerProps = React.ComponentProps<typeof RangePicker>;

export const LyloDateRange: React.FC<
...
> = ({
  ...
  return (
    <ProFormField
      valueType={LyloDateRangeValueType}
...
export const LyloDateRangeTransformCreator: (
  col: ProColumns
...
export const LyloDateRangeRenderConfig: ProRenderFieldPropsType = {
